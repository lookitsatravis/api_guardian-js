...
class ApiGuardian {
  ...
  async refreshCurrentUser() {
    ...
    if(TokenUtils.isAuthDataValid(authData)) {
      ...
      let userUrl = UrlUtils.buildLoginUrl(tokenData.user.id);
      ...
      try {
        ...
        try {
          ...
          this::__buildCurrentUser(tokenData, data);
...
function __getLocalStorage() {
  let authData = localStorage.getItem(this.config.localStorageKey);
